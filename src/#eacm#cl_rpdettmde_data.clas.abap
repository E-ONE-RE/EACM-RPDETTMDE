class /EACM/CL_RPDETTMDE_DATA definition
  public
  final
  create public .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_rie_detail,
        ...
        zimpu          TYPE /eacm/zimpu,
        koein          TYPE /eacm/zkoein,
        zimii          TYPE /eacm/zimii,
        zimiidd        TYPE /eacm/zimiidd,
        zimpe          TYPE /eacm/zimpe,
        zimst          TYPE /eacm/zimst,
        zlord          TYPE /eacm/zlord,
        zimlr          TYPE /eacm/zimlr,
...
CLASS /EACM/CL_RPDETTMDE_DATA IMPLEMENTATION.
  METHOD get_data.
  ...
  METHOD calculate_business_amounts.
    ...
    LOOP AT ct_riepilogo ASSIGNING FIELD-SYMBOL(<rie>).
      ...
      IF <rie>-ziman IS NOT INITIAL.
        <rie>-ImpProvv = <rie>-ziman.
        <rie>-ImpMatur = <rie>-zimmg.
        <rie>-ImpDaMat = <rie>-ImpProvv - <rie>-ImpMatur.
      ELSE.
        <rie>-ImpProvv = <rie>-zimco.
        <rie>-ImpMatur = <rie>-zimmg.
        <rie>-ImpDaMat = <rie>-ImpProvv - <rie>-ImpMatur.
      ENDIF.
    ENDLOOP.
