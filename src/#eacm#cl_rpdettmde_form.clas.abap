class /EACM/CL_RPDETTMDE_FORM definition
  public
  final
  create public .
  ...
  PUBLIC SECTION.
    CLASS-METHODS get_pdf_from_data
      IMPORTING
        is_action_input TYPE /eacm/cl_rpdettmde_data=>ty_mde_action_input
        it_riepilogo    TYPE /eacm/cl_rpdettmde_data=>tt_rie_detail
...
CLASS /eacm/cl_rpdettmde_form IMPLEMENTATION.
  METHOD get_pdf_from_data.
    CONSTANTS lc_form_name TYPE fpname VALUE '/EACM/FR_RPDETTMDE'.
    CONSTANTS lc_form_name_d TYPE fpname VALUE '/EACM/FR_RPDETTMDE'. " '/EACM/FR_RPDETTMDE_D'.
    ...
    rv_pdf = render_pdf_from_xml(
      ...
      iv_form_name = COND #(
        WHEN is_action_input-DetailPrint = abap_true
        THEN lc_form_name_d
        ELSE lc_form_name ) ).
  ENDMETHOD.
  ...
  METHOD build_summary_form_model.
    ...
    FIELD-SYMBOLS:
      <rie>           TYPE /eacm/cl_rpdettmde_data=>ty_rie_detail,
    ...
    LOOP AT it_riepilogo ASSIGNING <rie>.
      ...
      rs_form-header-totalimpprovv += <rie>-ImpProvv.
      rs_form-header-totalimpmatur += <rie>-ImpMatur.
      rs_form-header-totalimpdamat += <rie>-ImpDaMat.
      ...
      <agent>-agenttotalprovv += <rie>-ImpProvv.
      <agent>-agenttotalmatur += <rie>-ImpMatur.
      <agent>-agenttotaldamat += <rie>-ImpDaMat.
      ...
      <currency>-currencytotalprovv += <rie>-ImpProvv.
      <currency>-currencytotalmatur += <rie>-ImpMatur.
      <currency>-currencytotaldamat += <rie>-ImpDaMat.
      ...
      <agent_currency_total>-agentcurrencytotalprovv += <rie>-ImpProvv.
      <agent_currency_total>-agentcurrencytotalmatur += <rie>-ImpMatur.
      <agent_currency_total>-agentcurrencytotaldamat += <rie>-ImpDaMat.
      ...
      <customer>-customertotalprovv += <rie>-ImpProvv.
      <customer>-customertotalmatur += <rie>-ImpMatur.
      <customer>-customertotaldamat += <rie>-ImpDaMat.
...
***        ls_item-ztpcd = <rie>-ztpcd.
      ...
      <item>-impprovv += <rie>-ImpProvv.
      <item>-impmatur += <rie>-ImpMatur.
      <item>-impdamat += <rie>-ImpDaMat.
      ...
      <agent_total>-totalprovvigione += <rie>-ImpProvv.
      <agent_total>-totalmaturato += <rie>-ImpMatur.
      <agent_total>-totaldamaturare += <rie>-ImpDaMat.
      ...
      <general>-generaltotalprovv += <rie>-ImpProvv.
      <general>-generaltotalmatur += <rie>-ImpMatur.
      <general>-generaltotaldamat += <rie>-ImpDaMat.
      ...
      <general_total>-totalprovvigione += <rie>-ImpProvv.
      <general_total>-totalmaturato += <rie>-ImpMatur.
      <general_total>-totaldamaturare += <rie>-ImpDaMat.
  ...
  METHOD get_customer_texts.
    ...
    FIELD-SYMBOLS <rie> TYPE /eacm/cl_rpdettmde_data=>ty_rie_detail.
  ...
  METHOD build_file_name.
    ...
    rv_file_name = |RPDETTMDE_{ lv_bukrs }_{ lv_fkdat }_{ lv_scope }.pdf|.
  ENDMETHOD.
ENDCLASS.
